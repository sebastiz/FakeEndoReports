...
FINDINGS <- readLines(here::here("data","ImportPhrases"))
...
INDICATIONS <- readLines(here::here("data","OGDIndication"))
...
#Import the list of phrases for sentence construction
PATH_DUODENUM <- readLines(here::here("data","Path_Duodenum"))
...
#Import the list of phrases for sentence construction
PATH_BARRETTS <- readLines(here::here("data","Path_Barretts"))
...
#Import the list of phrases for sentence construction
PATH_OESOPHAGUS <- readLines(here::here("data","Path_Oeosophagus"))
...
#Import the list of phrases for sentence construction
PATH_STOMACH <- readLines(here::here("data","Path_Stomach"))
PATH_STOMACH<-gsub("\"","",PATH_STOMACH)
names(PATH_STOMACH) <- rep("x", length(PATH_STOMACH))
PATH_STOMACH <- as.list(PATH_STOMACH)
FD_StomachMacroscopic_Description<-ListContstructor("Macroscopic_Description","Description_Inflammation",PATH_STOMACH)

FD_StomachDescription_Inflammation<-ListContstructor("Description_Inflammation","Description_General",PATH_STOMACH)
FD_StomachDescription_Description_General<-ListContstructor("Description_General","Description_Dysplasia",PATH_STOMACH)
FD_StomachDescription_Dysplasia<-ListContstructor("Description_Dysplasia","Conclusion2",PATH_STOMACH)

FD_StomachConclusion2<-ListContstructor("Conclusion2","Conclusion_Polyp",PATH_STOMACH)
FD_StomachConclusion_Polyp<-ListContstructor("Conclusion_Polyp","Conclusion_Inflammation",PATH_STOMACH)
FD_StomachConclusion_Inflammation<-ListContstructor("Conclusion_Inflammation","Conclusion_Cancer",PATH_STOMACH)
FD_StomachConclusion_Cancer<-ListContstructor("Conclusion_Cancer","END",PATH_STOMACH)
